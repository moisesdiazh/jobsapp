...
<body class="bg-blue-200 min-h-screen leading-none">
...
{{-- le decimos que se centre verticalmente y el justify-around que pone un elemento a la izquierda y otro a la derecha --}}
...
<nav class="flex-1 text-right" >
        ...
        @else
            ...
            {{-- circulo de notificaciones con codigo para que aparezcan las no leidas--}}
